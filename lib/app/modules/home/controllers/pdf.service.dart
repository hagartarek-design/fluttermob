...
class LessonPdfViewer extends StatefulWidget {
  ...
  final lesson;final section;
   LessonPdfViewer({super.key, required this.lessonId, required this.totalPages,
  
  required this.index,required this.lesson,required this.section
  });
...
int contentCount=0;
  ...
  Widget build(BuildContext context) {
    List l=[];
    final imageUrl =
        '${Applinks.baseurl}/pdf/lesson/${widget.lessonId}/image/$currentIndex';  String formatDuration(Duration duration) {
...
,
  ...
  SizedBox(height: 24,)
      ...
      ,
          ...
          ,  Text('المحاضره للأسبوع الاول',textAlign: TextAlign.start,
...
,
 ...
 SizedBox(
  width:isMobile?400: 1120, child:  Wrap(
 ...
 Column(
  ...
  SizedBox(
            height: 40,  
              width:isMobile?400: 1120,child:Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
         Container(child:Wrap(
            ...
            Text('${controller.percentage.toStringAsFixed(0)}% مكتمل',style: TextStyle(color: Color.fromARGB(255, 80, 124, 181), fontSize: 12, fontWeight: FontWeight.w400)),
       ],) ), 
SizedBox(  width:isMobile?400: screenWidth,  child:
  Wrap( alignment: WrapAlignment.center,  children:
   [ LinearPercentIndicator( width:isMobile? screenWidth:1120, lineHeight: 8.0,
    barRadius: Radius.circular(16),percent: (controller. percentage / 100).clamp(0.0, 1.0), alignment:
     MainAxisAlignment.start, isRTL: true, progressColor: Color.fromARGB(255, 77, 195, 44)) ,])    ,
...
Container(width:isMobile?400: 1120,
  decoration: BoxDecoration(
  ...
  child: Stack(
    ...
    children: [
           ...
           Container(
                               ...
                               child: Image.network(width:isMobile?400: 1120, 
              imageUrl,
     ...
     Positioned(
      ...
      Positioned(
        ...
        child: Container(padding: EdgeInsets.fromLTRB(24, 13, 24, 13),
         ...
         Container(width: 120,child:  _buildPagination(controller, currentIndex,isMobile),)  
       ...
       SizedBox( width:isMobile?400: 1120,height: 547,
               child:
                Column(children: [
...
Container(child: Wrap(
  ...
  children: [
    InkWell(child:Container( width:isMobile?80.75: 271 ,height:100
...
InkWell(
  ...
  child:Container(width:isMobile?80.75: 271 ,height:100,decoration: BoxDecoration(  color: Color.fromARGB(255, 245, 245, 245),
 border: Border.all(width: 1,color: Color.fromARGB(255, 181, 181, 181)),
  borderRadius: BorderRadius.circular(8)
  ) ,child: 
Column(
...
print('Content items: $contentList');
  ...
  child:Container(
  width:isMobile?80.75: 271 ,height:100,decoration: BoxDecoration(
  color: Color.fromARGB(255, 245, 245, 245),
 border: Border.all(width: 1,color: Color.fromARGB(255, 181, 181, 181)),
  borderRadius: BorderRadius.circular(8)
  ) ,child: 
...
,
InkWell(child:Container( width:isMobile?80.75:271 ,height:100,decoration: BoxDecoration(
...
FontWeight.w500,fontSize:16,color: Color.
fromARGB(255, 245, 245, 245)),)
],) 
) , onTap: () async{ 
...
return Container ( width:isMobile ?400: 1120,height: 52,padding: EdgeInsets.fromLTRB(16, 14, 16, 14),
...
SizedBox(width:isMobile?80.75:112,height: 24, child:Row(spacing: 12,
mainAxisAlignment:
...
Container ( width:isMobile?80.75: 1120,height: 52,padding: EdgeInsets.fromLTRB(16, 14, 16, 14),
...
,borderRadius:BorderRadius.circular(12),
 ...
 child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
  Image.asset('assets/Group_10.png',width: 12.74,height: 17.1,),
SizedBox(width: 787,height: 24, child:Row(spacing: 12,mainAxisAlignment: MainAxisAlignment.start, 
children: [
...
child:Row(spacing: 12,mainAxisAlignment: MainAxisAlignment.start, 
children: [
...
Widget _buildFooter(BuildContext context,isMobile) {
