...
class LessonPdfViewer3 extends StatefulWidget {
  final int lessonId;
  final int totalPages; 

  final index;
  final lesson;
  const LessonPdfViewer3({super.key, required this.lessonId, required this.totalPages,
...
class _LessonPdfViewerState extends State<LessonPdfViewer3> {
  int currentIndex = 1;
...
List l=[];
    final imageUrl =
        '${Applinks.baseurl}/pdf/lesson/1/image/$currentIndex';  String formatDuration(Duration duration) {
  ...
  SizedBox(height: 24,)
        ,
          ...
          Container(child: Wrap(spacing: 1,
            ...
            children: [
        InkWell(child:Text('الرئيسية',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Color.fromARGB(255, 181, 181, 181)),
          ), onTap: (){
Navigator.push(context, MaterialPageRoute(builder: (context){
  return Homeafterlogin();
      ...
      , InkWell(child: Text('الصف الثالث الثانوي',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Color.fromARGB(255, 181, 181, 181)),
     ...
     Navigator.push(context, MaterialPageRoute(builder: (context){return Subjecttype();}));   
          ...
          return Subjectbooks();
            ...
            child: Text('مادة الفيزياء',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Color.fromARGB(255, 181, 181, 181)),)
            , 
          ) ,
              InkWell(child:    Text("احجزملازمك",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Color.fromARGB(255, 181, 181, 181)),)
           ,onTap: (){
            Navigator.push(context,MaterialPageRoute(builder: (context){
          return subjectBooks2();
        }));
              },) , 
              ...
              Container(width: 18,height: 18,decoration: BoxDecoration(),      child: Icon
            (Icons.arrow_forward_ios,color: Color.fromARGB(255, 181, 181, 181)),),
         Text('المحاضره  PDF للأسبوع الاول',style: TextStyle(color: Color.fromARGB(255, 6, 69, 152)),)
            ,
           ...
           SizedBox(width:1120,child: Column(
            ...
            children: [
              SizedBox(height: 12,)
           , Text('المحاضره PDF للأسبوع الاول ',textAlign: TextAlign.start,style:
             TextStyle(fontWeight: FontWeight.w600,
           fontSize: 32,color: Color.fromARGB(255, 6, 69, 152)),),SizedBox(height: 12,)
          ,  Text('ملخصPDF قانون اوم',textAlign: TextAlign.start,
