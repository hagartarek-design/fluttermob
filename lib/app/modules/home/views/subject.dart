  ...
  SizedBox(height: 24,)
        ,
          ...
          ,
            ...
            InkWell(child: 
            Text('الصف الثالث الثانوي',style: 
            TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Color.fromARGB(255, 181, 181, 181)),
          ...
          InkWell(
            ...
            child:Text('الفيزياء',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,
