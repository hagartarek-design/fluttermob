...
width: !isMobile?1280:screenWidth,     
      ...
      runAlignment: WrapAlignment.center,
        ...
        InkWell(
          ...
          child:      Text('الرئيسية',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400
  ...
  ,
    ...
    InkWell(
      ...
      ,  color: Color.fromARGB(255, 181, 181, 181),
        ...
        Icon(Icons.arrow_forward_ios,color: Color.fromARGB(255, 181, 181, 181),size: 18,),
          Text('احجز السنتر',style: TextStyle( fontWeight: FontWeight.w400
      ,  color: Color.fromARGB(255, 6, 69, 152)),
          ),
